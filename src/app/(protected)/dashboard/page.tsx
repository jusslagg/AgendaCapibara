  ...
  return (
    <main className="px-5 pb-10 pt-4 sm:px-8 sm:pt-8 xl:px-12">
      <div className="creative-masthead relative mb-8 flex min-h-44 flex-col justify-end gap-5 overflow-hidden rounded-[2rem] border border-white/10 bg-[#0a0a0c] p-6 text-white sm:flex-row sm:items-end sm:justify-between sm:p-8">
        <Image alt="Composición abstracta de cintas, planos y formas cromáticas" className="prism-only pointer-events-none absolute inset-0 h-full w-full object-cover object-center opacity-70" fill priority sizes="(max-width: 640px) 100vw, 80vw" src="/prism-abstract.png" />
        <CapiCharacter mood="party" className="non-prism-only pointer-events-none absolute -bottom-20 right-8 h-64 opacity-75" />
      ...
      <section className="workflow-board prism-only relative mt-6 overflow-hidden rounded-[2rem] border border-white/10 bg-black text-white shadow-[0_24px_65px_rgba(0,0,0,.28)]">
