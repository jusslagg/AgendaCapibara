...
export default function SettingsPage() {
  ...
  return (
    <main className="px-5 pb-10 pt-4 sm:px-8 sm:pt-8 xl:px-12">
      <PageHeading eyebrow="Todo bajo control" title="Recordatorios y app" description="Activá los avisos una vez en cada dispositivo donde uses CapiAgenda." />
      <ThemeSelector />
      <div className="grid max-w-5xl gap-5 lg:grid-cols-2">
        ...
        {installed === false && (
          <section className="surface relative overflow-hidden rounded-[2rem] p-6 sm:p-8">
            ...
            <h2 className="mt-5 text-xl font-black">Instalar CapiAgenda</h2>
